...
class PokeBattle_Move_008 < PokeBattle_Move
  ...
  def pbModifyBaseAccuracy(baseaccuracy,attacker,opponent)
    ...
    when PBWeather::RAINDANCE, PBWeather::HEAVYRAIN, PBWeather::THUNDERSTORM
      return 0
...
class PokeBattle_Move_160 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::PLAGUE
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Sandstorm",nil,nil)
    @battle.pbDisplay(_INTL("A pestilent wind started to blow!"))
    return 0
  end
end
...
class PokeBattle_Move_161 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::ECLIPSE
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Eclipse",nil,nil)
    @battle.pbDisplay(_INTL("The light of the field disappeared!"))
    return 0
  end
end

################################################################################
# Target's evasion stat changes are ignored from now on. (Dragon Gem)
# Dragon moves have normal effectiveness against the Fairy-type target.
################################################################################
class PokeBattle_Move_162 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.effects[PBEffects::DragonGem]=true
    @battle.pbDisplay(_INTL("{1} was identified!",opponent.pbThis))
    return 0
  end
end
...
################################################################################
# Target's defens and speed stat are lowered one stage (Dragon Roar)
################################################################################
class PokeBattle_Move_163 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanReduceStatStage?(PBStats::DEFENSE,attacker,true,self) && !opponent.pbCanReduceStatStage?(PBStats::SPEED,attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    ret=opponent.pbReduceStat(PBStats::DEFENSE,1,attacker,false,self)
    ret1=opponent.pbReduceStat(PBStats::SPEED,1,attacker,false,self)
    return (ret || ret1) ? 0 : -1
  end
  ...
  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanReduceStatStage?(PBStats::DEFENSE,attacker,false,self)
      opponent.pbReduceStat(PBStats::DEF,1,attacker,false,self)
    end
    if opponent.pbCanReduceStatStage?(PBStats::SPEED,attacker,false,self)
      opponent.pbReduceStat(PBStats::SPEED,1,attacker,false,self)
    end
...
################################################################################
# Starts ancestral aurora weather. (Ancestral Aurora)
################################################################################
class PokeBattle_Move_164 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::ANCESTRALAURORA
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("AncestralAurora",nil,nil)
    @battle.pbDisplay(_INTL("A draconic aurora appeared!"))
    return 0
  end
end
...
class PokeBattle_Move_165 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::THUNDERSTORM
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Thunderstorm",nil,nil)
    @battle.pbDisplay(_INTL("A thunderstorm ragged!"))
    return 0
  end
end

################################################################################
# Starts magic wind weather. (Magic Wind)
################################################################################
class PokeBattle_Move_166 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::MAGICWIND
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("MagicWind",nil,nil)
    @battle.pbDisplay(_INTL("A magic wind brew!"))
    return 0
  end
end

################################################################################
# Starts feral breeze weather. (Feral Breeze)
################################################################################
class PokeBattle_Move_167 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::FERALBREEZE
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("FeralBreeze",nil,nil)
    @battle.pbDisplay(_INTL("A soft but unnerving breeze brew!"))
    return 0
  end
end

################################################################################
# Starts crowd weather. (Showing Off)
################################################################################
class PokeBattle_Move_168 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::CROWD
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Crowd",nil,nil)
    @battle.pbDisplay(_INTL("An enthusiatic crowd gathered to see the battle!"))
    return 0
  end
end

################################################################################
# Starts tornado weather. (Tornado)
################################################################################
class PokeBattle_Move_169 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::TORNADO
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Tornado",nil,nil)
    @battle.pbDisplay(_INTL("A small tornado formed on the field!"))
    return 0
  end
end

################################################################################
# Starts scary fog weather. (Scary Fog)
################################################################################
class PokeBattle_Move_170 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::SCARYFOG
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("ScaryFog",nil,nil)
    @battle.pbDisplay(_INTL("A creepy intense fog surrounded the field!"))
    return 0
  end
end

################################################################################
# Starts pollen season weather. (Pollen Season)
################################################################################
class PokeBattle_Move_171 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::POLLENSEASON
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("PollenSeason",nil,nil)
    @battle.pbDisplay(_INTL("Pollen particles surrounded the field!"))
    return 0
  end
end

################################################################################
# Starts tremors weather. (Tremors)
################################################################################
class PokeBattle_Move_172 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::TREMORS
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("Tremors",nil,nil)
    @battle.pbDisplay(_INTL("The field started to shake!"))
    return 0
  end
end

################################################################################
# Starts strong blizzard weather. (Strong Blizzard)
################################################################################
class PokeBattle_Move_173 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::STRONGBLIZZARD
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("StrongBlizzard",nil,nil)
    @battle.pbDisplay(_INTL("A huge blizzard roars!"))
    return 0
  end
end
...
class PokeBattle_Move_174 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::ACIDRAIN
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("AcidRain",nil,nil)
    @battle.pbDisplay(_INTL("Poisonus and flamable rain started to fall!"))
    return 0
  end
end

################################################################################
# Starts starry night weather. (Starry Night)
################################################################################
class PokeBattle_Move_175 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::STARRYNIGHT
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("StarryNight",nil,nil)
    @battle.pbDisplay(_INTL("A bright and wierd nightfall covered the field!"))
    return 0
  end
end

################################################################################
# Starts meteor shower weather. (Meteor Shower)
################################################################################
class PokeBattle_Move_176 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("MeteorShower",nil,nil)
    @battle.pbDisplay(_INTL("Meteors started bombarding the field!"))
    return 0
  end
end

################################################################################
# Starts magnetic storm. (Magnetic Storm)
################################################################################
class PokeBattle_Move_177 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    @battle.weather=PBWeather::MAGNETICSTORM
    @battle.weatherduration=5
    @battle.weatherduration=8 if attacker.hasWorkingItem(:SMOOTHROCK)
    @battle.pbCommonAnimation("MagneticStorm",nil,nil)
    @battle.pbDisplay(_INTL("Magnetism spreads through the field!"))
    return 0
  end
end

################################################################################
# Increases ATK and reduces oponents DEF. (Hunting Roar)
################################################################################
class PokeBattle_Move_178 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    ret=attacker.pbIncreaseStat(PBStats::ATTACK,1,attacker,false,self)
    if opponent.pbCanReduceStatStage?(PBStats::DEFENSE,attacker,false,self)
        opponent.pbReduceStat(PBStats::DEFENSE,1,attacker,false,self,true)
    end
    return ret ? 0 : -1
  end
...
################################################################################
# Maximizes ATK and SPEED but minimizes DEF and SP DEF. (Instinct Overdrive)
################################################################################
class PokeBattle_Move_179 < PokeBattle_Move
    def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    if !attacker.pbCanIncreaseStatStage?(PBStats::ATTACK,attacker,false,self) && !attacker.pbCanIncreaseStatStage?(PBStats::SPEED,attacker,false,self)
      @battle.pbDisplay(_INTL("But it failed!"))
      return -1
    end
    if attacker.hasWorkingAbility(:CONTRARY)
      opponent.pbReduceStat(PBStats::DEFENSE,1,attacker,false,self)
      attacker.stages[PBStats::SPEED]=-6     
      @battle.pbCommonAnimation("StatDown",attacker,nil)
      @battle.pbDisplay(_INTL("{1} minimized its Attack and Speed!",attacker.pbThis))

      attacker.stages[PBStats::DEFENSE]=6
      attacker.stages[PBStats::SPDEF]=6 
      @battle.pbCommonAnimation("StatUp",attacker,nil)   
      @battle.pbDisplay(_INTL("{1} maximized its Defense and Sp. Defense!",attacker.pbThis))
    else
      attacker.stages[PBStats::ATTACK]=6
      attacker.stages[PBStats::SPEED]=6
      @battle.pbCommonAnimation("StatUp",attacker,nil)
      @battle.pbDisplay(_INTL("{1} maximized its Attack and Speed!",attacker.pbThis))

      attacker.stages[PBStats::DEFENSE]=-6
      attacker.stages[PBStats::SPDEF]=-6  
      @battle.pbCommonAnimation("StatDown",attacker,nil)
      @battle.pbDisplay(_INTL("{1} minimized its Defense and Sp. Defense!",attacker.pbThis))
    end
    return 0
  end
end
...
################################################################################
# Raises ATK and lowers DEF. (Attack Stance)
################################################################################
class PokeBattle_Move_17A < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    ret=attacker.pbIncreaseStat(PBStats::ATTACK,2,attacker,false,self)
    if attacker.pbCanReduceStatStage?(PBStats::DEFENSE,attacker,false,self)
        attacker.pbReduceStat(PBStats::DEFENSE,1,attacker,false,self,true)
    end
    return ret ? 0 : -1
  end
...
################################################################################
# Raises DEF and lowers ATK. (Defense Stance)
################################################################################
class PokeBattle_Move_17B < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    ret=attacker.pbIncreaseStat(PBStats::DEFENSE,2,attacker,false,self)
    if attacker.pbCanReduceStatStage?(PBStats::ATTACK,attacker,false,self)
        attacker.pbReduceStat(PBStats::ATTACK,1,attacker,false,self,true)
    end
    return ret ? 0 : -1
  end
...
################################################################################
# Heals the target but also burns it (Phoenix Will).
################################################################################
class PokeBattle_Move_17C < PokeBattle_Move
  ...
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    pbShowAnimation(@id,attacker,nil,hitnum,alltargets,showanimation)
    attacker.pbBurnSelf()
    @battle.pbDisplay(_INTL("{1} burn himself and became healthy!",attacker.pbThis))
    hp=attacker.pbRecoverHP(attacker.totalhp-attacker.hp,true)
    @battle.pbDisplay(_INTL("{1}'s HP was restored.",attacker.pbThis)) if hp>0
    return 0
  end
...
################################################################################
# Makes the target wet.
################################################################################
class PokeBattle_Move_180 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanWet?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbWet(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanWet?(attacker,false,self)
      opponent.pbWet(attacker)
    end
  end
end
...
################################################################################
# Gives the target a rash.
################################################################################
class PokeBattle_Move_181 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanRash?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbRash(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanRash?(attacker,false,self)
      opponent.pbRash(attacker)
    end
  end
end
...
class PokeBattle_Move_182 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanBruised?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbBruised(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanBruised?(attacker,false,self)
      opponent.pbBruised(attacker)
    end
  end
end
...
################################################################################
# Makes the target dirty.
################################################################################
class PokeBattle_Move_182 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanDirty?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbDirty(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanDirty?(attacker,false,self)
      opponent.pbDirty(attacker)
    end
  end
end
...
################################################################################
# Makes the target lose its balance.
################################################################################
class PokeBattle_Move_183 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanUnbalanced?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbUnbalanced(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanUnbalanced?(attacker,false,self)
      opponent.pbUnbalanced(attacker)
    end
  end
end
...
################################################################################
# Shatters the targets mind.
################################################################################
class PokeBattle_Move_184 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanMindShattered?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbMindShattered(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanMindShattered?(attacker,false,self)
      opponent.pbMindShattered(attacker)
    end
  end
end
...
class PokeBattle_Move_185 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanStung?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbStung(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanStung?(attacker,false,self)
      opponent.pbStung(attacker)
    end
  end
end
...
class PokeBattle_Move_186 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanPetrify?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
  ...
  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanPetrify?(attacker,false,self)
      opponent.pbPetrify(attacker)
    end
  end
end
...
################################################################################
# The targets become afraid.
################################################################################
class PokeBattle_Move_187 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanFear?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbFear(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanFear?(attacker,false,self)
      opponent.pbFear(attacker)
    end
  end
end
...
################################################################################
# The attacker awakens.
################################################################################
class PokeBattle_Move_188 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !attacker.pbCanAwakened?(attacker,true,self)
    attacker.pbAwakened(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    if attacker.pbCanAwakened?(attacker,false,self)
      attacker.pbAwakened(attacker)
    end
  end
end
...
################################################################################
# The targets is blinded.
################################################################################
class PokeBattle_Move_189 < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !opponent.pbCanBlinded?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbBlinded(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanBlinded?(attacker,false,self)
      opponent.pbBlinded(attacker)
    end
  end
end
...
################################################################################
# The targets is covered in shrapnel.
################################################################################
class PokeBattle_Move_18A < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    return -1 if !opponent.pbCanBlinded?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbShrapnel(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanShrapnel?(attacker,false,self)
      opponent.pbShrapnel(attacker)
    end
  end
end
...
################################################################################
# The attacker becomes enchanted.
################################################################################
class PokeBattle_Move_18B < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    return super(attacker,opponent,hitnum,alltargets,showanimation) if pbIsDamaging?
    return -1 if !attacker.pbCanAwakened?(attacker,true,self)
    attacker.pbEnchanted(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    if attacker.pbCanEnchanted?(attacker,false,self)
      attacker.pbAEnchanted(attacker)
    end
  end
end

################################################################################
# The targets is bleeding.
################################################################################
class PokeBattle_Move_18C < PokeBattle_Move
  def pbEffect(attacker,opponent,hitnum=0,alltargets=nil,showanimation=true)
    ...
    return -1 if !opponent.pbCanBlinded?(attacker,true,self)
    pbShowAnimation(@id,attacker,opponent,hitnum,alltargets,showanimation)
    opponent.pbBleeding(attacker)
    return 0
  end

  def pbAdditionalEffect(attacker,opponent)
    return if opponent.damagestate.substitute
    if opponent.pbCanBleeding?(attacker,false,self)
      opponent.pbBleeding(attacker)
    end
  end
end
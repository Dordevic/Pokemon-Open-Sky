...
def pbDexNames; return [
   ...
   [_INTL("Johto Pokédex"),2],
   [_INTL("Hoenn Pokédex"),3],
   [_INTL("Sinnoh Pokédex"),4],
   [_INTL("Unova Pokédex"),5],
   [_INTL("Center Kalos Pokédex"),6],
   [_INTL("Costal Kalos Pokédex"),7],
   [_INTL("Mountain Kalos Pokédex"),8],
   [_INTL("Alola Pokédex"),9],
